...
const rules = [
    ...
    { match: /\btext-blue-600\b/g, replace: 'text-blue-600 dark:text-blue-400' },
    { match: /\bblue-700\b/g, replace: 'blue-700 dark:blue-600' }
];

let updatedCount = 0;

files.forEach(file => {
    // skip layouts to avoid duplicating the dark mode classes recently added or breaking dashboard
